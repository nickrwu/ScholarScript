  ...
  return (
    <div className="col-auto col-sm-2 col-md-3 col-xl-2 px-sm-2 px-0 min-vh-100 d-flex justify-content-between flex-column">
      <div className="py-4 px-2">
        <a href="/" className="text-decoration-none text-dark d-none d-md-inline d-flex align-itemcenter p-3" href="/">
      ...
      <div className="profile">
        <a className="text-decoration-none text-dark fs-2 p-4" type="button" id="triggerId" aria-expanded="false">
